      ...
      <div className="d-flex flex-row justify-content-between align-items-start bg-light w-100 p-4">
        <div className="w-100">
          <h4 className="fw-bold my-2">
            {invoice?.info?.billFrom || "John Uberbacher"}
          </h4>
            ...
            {invoice?.items.map((item, i) => {
              return (
                <tr id={i} key={i}>
                  ...
                  <td className="text-end" style={{ width: "100px" }}>
                    {invoice?.currency} {item?.price * item?.quantity}
                  </td>
                </tr>
              );
            })}
          ...
          <tbody>
            ...
            {invoice?.taxAmmount !== 0.0 && (
              <tr className="text-end">
                ...
                <td className="text-end" style={{ width: "100px" }}>
                  {invoice?.currency} {invoice?.taxAmmount}
                </td>
              </tr>
            )}
            {invoice?.discountAmmount !== 0.0 && (
              <tr className="text-end">
                ...
                <td className="text-end" style={{ width: "100px" }}>
                  {invoice?.currency} {invoice?.discountAmmount}
                </td>
              </tr>
            )}
            <tr className="text-end">
